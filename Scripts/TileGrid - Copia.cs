...
public class TileGrid_Backup : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown("space"))
        {
            ...
            // if(debug_var){print("END - Fill void\n");}
            //
            // if(debug_var){print("END - Actions");}
    ...
    void updateTilesPositionDictionary(){
        ...
        foreach(Transform child in tiles_container.transform){
            ...
            // print(i + " UPDATE DICT: \t" + tmp_tiles.transform.position + "\t" + tmp_tiles + " " + (tmp_tiles == null));
            // i++;
        }

        // i = 0;
        // print("AFTER UPDATE:");
        // foreach(Vector3 key_tmp in tiles_position_dictionary.Keys){
        //     print(i + " UPDATE DICT: \t" + key_tmp + "\t" + tiles_position_dictionary[key_tmp]);
        //     i++;
        // }
    ...
    void fillVoidWithTiles()
    {
        ...
        if(size == 2){
            ...
            // Retrieve the tiles finder
            // GameObject tiles_finder =  GameObject.Find("Tiles Finder");
            ...
            for(int i = 0; i < size; i++){
                for(int j = 0; j < size; j++){
                    ...
                    // print("\t" + tiles_finder.transform.position);
                    ...
                    if(i < size / 2){
                        ...
                        // print("\t\t condition_diag_1 = " + condition_diag_1 + "\t y = " + tiles_finder.transform.position.y + " y_th = " + (tiles_finder.transform.position.x + this.size/2));
                        // print("\t\t condition_diag_2 = " + condition_diag_2 + "\t y = " + tiles_finder.transform.position.y + " y_th = " + (-tiles_finder.transform.position.x + this.size/2));
                    } else {
                    ...
                    if(condition_diag_1 && condition_diag_2){
                        ...
                        if(checkSurroundingPositionWithDict()){
                            // print("\t\t\t SPAWN TILES COUPLE - " + tiles_finder.transform.position);
